...
namespace Logify.Mobile.ViewModels {
    public class ReportFilterViewModel : NotificationObject {
        IApplicationListDataProvider dataProvider { get => DataProviderFactory.CreateApplicationListDataProvider(); }
        ...
        public bool ApplicationSeparatorVisible { get { return this.separatorVisible; } }
        ...
        private void Instance_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e) {
            this.separatorVisible = TeamsViewModel.Instance.IsMultiItems || SubscriptionsViewModel.Instance.IsMultiItems;
            OnPropertyChanged(nameof(ReportFilterViewModel.ApplicationSeparatorVisible));
        }
        ...
        void UpdateFilterString() {
            ...
            this.filterViewModel.FilterString = string.Join(statuses.Any() && apiKeys.Any() ? " and " : "",
