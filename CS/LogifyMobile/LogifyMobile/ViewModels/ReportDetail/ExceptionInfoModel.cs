...
namespace Logify.Mobile.ViewModels.ReportDetail {
    public class ExceptionInfoModel: ExceptionInfo {
        ...
        public ExceptionInfoModel(ExceptionInfo exception) {
            Header = exception.Header + Environment.NewLine;
            Type = exception.Type + Environment.NewLine;
            Message = exception.Message;
            if (exception.Stack != null) {
                StackText = string.Empty;
                foreach (string stackLine in exception.Stack) {
                    StackText += stackLine + Environment.NewLine;
                }
            }
        }
    }
