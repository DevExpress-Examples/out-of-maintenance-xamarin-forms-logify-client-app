...
namespace Logify.Mobile.ViewModels {
    public class SubscriptionsViewModel : PickerViewModelBase {
        static readonly Lazy<SubscriptionsViewModel> viewModel = new Lazy<SubscriptionsViewModel>(() => new SubscriptionsViewModel(), true);
        public static SubscriptionsViewModel Instance => viewModel.Value;

        protected override string SelectedItemId {
            get => settings.SubscriptionId;
