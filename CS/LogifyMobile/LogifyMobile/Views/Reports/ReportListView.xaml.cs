...
namespace Logify.Mobile.Views {
    public partial class ReportListView : ContentPage {
        ...
        async void Handle_Tap(object sender, DevExpress.XamarinForms.DataGrid.DataGridGestureEventArgs e) {
            if(e.Item != null)
                await Application.Current.MainPage.Navigation.PushAsync(new ReportDetailsPage((ReportViewModel)e.Item));
        }
        ...
        void Settings_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e) {
            if (e.PropertyName == nameof(PickerViewModelBase.SelectedItem)) { 
                ...
                ((ReportListViewModel)BindingContext).RefreshCommand?.Execute(this);
            }
