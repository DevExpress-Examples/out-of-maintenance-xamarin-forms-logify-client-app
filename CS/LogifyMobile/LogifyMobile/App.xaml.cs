...
namespace Logify.Mobile {
    public partial class App : Application {
        public App() {
            ...
            LogifyDataModeContext.GetAvailableModes();

            Page firstPage;
            if (LogifyDataModeContext.SelectedMode != null && LogifyDataModeContext.SelectedMode.SkipLoginPage)
